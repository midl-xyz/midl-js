...
const SvgComponent = (props: SVGProps<SVGSVGElement>) => (
	...
	<svg
		...
		viewBox="0 0 42 42"
		fill="none"
		className="satoshi-kit--w_8 satoshi-kit--h_8 satoshi-kit--bdr_md satoshi-kit--w_10 satoshi-kit--h_10"
		{...props}
	>
		<g clipPath="url(#a)">
			<path
